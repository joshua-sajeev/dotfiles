...
static const char *fonts[] = {"jetbrainsmononl:size=14"};
static const char dmenufont[] = "jetbrainsmononl:size=11";
...
static const char *togglevolume[] = {"amixer", "sset", "Master", "toggle",
                                     NULL};
...
static const char *lock[] = {"i3lock", "-i", "/home/joshua/.dwm/lock.png",
                             NULL};
