...
globalkeys = gears.table.join(
    ...
    --rofi 
    awful.key({modkey}, 'r', function() awful.util.spawn('rofi -show combi -modes combi -combi-modes "window,drun,run"') end, {description='run rofi', group='launcher'}),
    -- Dmenu
    awful.key({ modkey },            "p",     function () awful.util.spawn("firefox") end,
